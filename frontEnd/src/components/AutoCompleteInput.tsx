...
//Usado para o Filtro.tsx, serve para otimizar a filtragem atráves dos algortimos de busca em cadeia.
// Ele também faz com que seja possível navegar com a setinha e selecionar com o Enter