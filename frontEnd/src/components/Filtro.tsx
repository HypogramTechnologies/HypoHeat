    ...
    <div style={styles.filterContainer}>
      <form onSubmit={handleSubmit}>
        <AutoCompleteInput
          ...
          value={filtro.biome}
          options={allBiomes} 
          onChange={(value) => handleFilterChange("biome", value)} 
          onSelect={(value) => handleFilterChange("biome", value)}
        ...
        <div style={styles.inputGroup}>
          ...
          <input
            ...
            // CORREÇÃO AQUI: Use o spread operator "..." para aplicar as propriedades de estilo
